    ...
    const fetchQuote = async () => {
      try {
        ...
        if (result.success) {
          ...
          router.push('/labs/dashboard/quotes')
        }
      } catch (error) {
        toast({
          title: 'Error',
    ...
    try {
      ...
      if (result.success) {
        if (send) {
          ...
          if (isNew) {
            router.push(`/labs/dashboard/quotes/${result.data.id}`)
          } else {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link href="/labs/dashboard/quotes">
        ...
        <div className="flex gap-2">
          <Link href={isNew ? '#' : `/labs/dashboard/quotes/${quoteId}/preview`}>
