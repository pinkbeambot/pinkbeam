...
interface LabsResourcesPageClientProps {
...
export function LabsResourcesPageClient({ initialResources }: LabsResourcesPageClientProps) {
        ...
        <div className="container relative">
          <FadeInOnMount>
            <div className="max-w-3xl mx-auto text-center">
              <Badge variant="outline" className="mb-4 px-3 py-1 border-cyan-500/30 text-cyan-500">
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-8">
                      ...
                      <div className="space-y-1">
                        <button
                          ...
                          className={cn(
                            ...
                            !selectedCategory ? "bg-cyan-500/10 text-cyan-600" : "hover:bg-muted"
                          )}
                        >
                          All Categories
                        </button>
                        {categories.map((category) => (
                          <button
                            ...
                            className={cn(
                              "w-full text-left px-3 py-2 rounded-lg text-sm transition-colors",
                              selectedCategory === category ? "bg-cyan-500/10 text-cyan-600" : "hover:bg-muted"
                            )}
                          >
                            {category}
                          </button>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {allTopics.slice(0, 10).map((topic) => (
                          <button
                            ...
                            className="px-2 py-1 text-xs rounded-full bg-muted hover:bg-cyan-500/10 hover:text-cyan-600 transition-colors"
                          >
                            {topic}
                          </button>
                        ))}
            ...
            <main className="flex-1">
              ...
              {/* Recently Added */}
              {!searchQuery && !selectedTypes.length && !selectedCategory && filteredResources.length > 0 && (
                <FadeIn delay={0.2}>
                  <div className="mt-16">
                    <div className="flex items-center gap-2 mb-6">
      ...
      <CardContent className="p-0">
        <Link href={`/solutions/resources/${resource.slug}`}>
          <div className="p-6">
            ...
            {/* Title & Description */}
            <h3 className="text-lg font-semibold mb-2 group-hover:text-cyan-500 transition-colors line-clamp-2">
              {resource.title}
            </h3>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border/50">
              <div className="flex items-center gap-3 text-sm text-muted-foreground">
                <FileIcon format={resource.fileFormat} />
