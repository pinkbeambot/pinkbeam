            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" className="w-full" asChild>
                  <Link href={`/portal/admin/labs/time?projectId=${project.id}`}>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="flex items-center justify-between">
                ...
                <Button asChild>
                  <Link href="/portal/admin/labs/time">
        ...
        <TabsContent value="tasks" className="space-y-4">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <div className="flex gap-2">
                <Button variant="outline" asChild>
                  <Link href={`/portal/admin/labs/projects/${project.id}/tasks/list`}>
                    <CheckSquare className="w-4 h-4 mr-2" />
                    List View
                  </Link>
                </Button>
                <Button className="bg-cyan-600 hover:bg-cyan-700" asChild>
                  <Link href={`/portal/admin/labs/projects/${project.id}/tasks/board`}>
