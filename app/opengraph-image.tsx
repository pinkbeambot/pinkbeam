...
export const alt = "Pink Beam — AI-Powered Business Solutions";
export const size = {
  width: 1200,
  height: 630,
};
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Hire AI employees. Build websites. Develop software. Get consulting.
        </p>
        ...
        >
          {["Agents", "Web", "Labs", "Solutions"].map((service) => (
            <div
              key={service}
              style={{
                padding: "12px 24px",
