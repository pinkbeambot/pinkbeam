...
-- ==================================================================
-- Based on existing tables scan - creates only what's missing
-- Run this in Supabase Dashboard → SQL Editor
-- ==================================================================

-- Missing Invoice-related Tables
-- ==================================================================
...
CREATE TABLE IF NOT EXISTS "invoice_line_items" (
  ...
  "timeEntryId" TEXT,
  CONSTRAINT "invoice_line_items_invoiceId_fkey" FOREIGN KEY ("invoiceId") REFERENCES "invoices"("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "project_updates" (
  ...
  CONSTRAINT "project_updates_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE
);
...
CREATE INDEX IF NOT EXISTS "project_updates_projectId_idx" ON "project_updates"("projectId");
CREATE INDEX IF NOT EXISTS "project_updates_projectId_createdAt_idx" ON "project_updates"("projectId", "createdAt");
CREATE INDEX IF NOT EXISTS "project_updates_visible_idx" ON "project_updates"("visible");
...
-- Subscription indexes (including Phase 2 requirement)
...
-- ==================================================================
-- ✅ COMPLETE! All missing tables and Phase 2 indexes created.
-- Next: Run "npx prisma generate" in your terminal
-- ==================================================================
