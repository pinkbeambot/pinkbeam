...
// Labs services data for dropdown
const labsServices = [
  {
    id: "webapps",
  ...
  },
  {
    id: "mobile",
    name: "Mobile Apps",
    description: "iOS and Android native & cross-platform",
    icon: Smartphone,
    href: "/labs#mobile",
  },
  {
  ...
  },
  {
    id: "ai",
    name: "AI Solutions",
    description: "Custom AI models and automation",
    icon: Brain,
    href: "/labs#ai",
  },
];
...
function Logo({ className }: { className?: string }) {
  return (
    <Link href="/labs" className={cn("flex items-center gap-2", className)}>
      <div className="relative flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-cyan-500 to-cyan-600">
        <span className="text-white font-display font-bold text-sm">PB</span>
        <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-cyan-500 to-cyan-600 blur-md opacity-50" />
      </div>
      <span className="font-display font-bold text-xl tracking-tight">
        <span className="text-gradient-cyan">Pink</span>
        <span className="text-foreground"> Beam</span>
      </span>
      <span className="hidden sm:inline-flex text-xs font-medium text-muted-foreground ml-1 px-2 py-0.5 rounded-full border border-cyan-500/30 bg-cyan-500/10 text-cyan-500">
        Labs
      </span>
    </Link>
  );
...
function ServiceCard({ service }: { service: typeof labsServices[0] }) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-cyan-500 shrink-0">
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56" align="end" forceMount>
        ...
        <DropdownMenuItem asChild>
          <Link href="/labs/dashboard" className="cursor-pointer">
              ...
              >
                ...
                >
                  ...
                  <div className="mt-3 pt-3 border-t border-border">
                    ...
                    >
                      <button className="flex items-center justify-between w-full px-3 py-2 text-sm font-medium text-cyan-500 hover:bg-cyan-500/10 rounded-lg transition-colors">
      ...
      <SheetContent side="right" className="w-full sm:w-[400px] p-0">
        <SheetHeader className="p-6 border-b border-border">
          <SheetTitle className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-cyan-500 ml-1 px-2 py-0.5 rounded-full border border-cyan-500/30 bg-cyan-500/10">
              Labs
            </span>
          </SheetTitle>
        </SheetHeader>
        ...
        <div className="flex flex-col h-[calc(100vh-140px)] overflow-y-auto">
                  ...
                  <div className="px-4 pb-4 space-y-2">
                    {labsServices.map((service) => (
                      <SheetClose key={service.id} asChild>
                        ...
                        >
                          <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-cyan-500 shrink-0">
          ...
          {!user && (
            <div className="mt-auto p-4 space-y-3">
              ...
              <SheetClose asChild>
                <Link href="/sign-up">
                  <Button className="w-full bg-gradient-to-r from-cyan-500 to-cyan-600 hover:opacity-90" size="lg">
                    Start Your Project
                  </Button>
                </Link>
              </SheetClose>
                ...
                <>
                  {user ? (
                    ...
                    <>
                      ...
                      <Link href="/sign-up">
                        <Button className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:opacity-90" size="sm">
                          Start Your Project
                        </Button>
                      </Link>
                    </>
