...
// Solutions-specific nav links
const navLinks = [
  { label: "Services", href: "/solutions#services", hasDropdown: false },
  { label: "Workshops", href: "/solutions#workshops", hasDropdown: false },
  { label: "Insights", href: "/solutions#insights", hasDropdown: false },
            ...
            {user ? (
              ...
              <div className="hidden sm:flex items-center gap-2">
                ...
                <Button size="sm" className="bg-gradient-beam hover:opacity-90" asChild>
                  <Link href="/solutions#contact">Book Consultation</Link>
                </Button>
              </div>
            )}
