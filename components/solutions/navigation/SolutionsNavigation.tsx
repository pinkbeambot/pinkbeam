...
import { Menu, ChevronRight, Lightbulb, Target, TrendingUp, Users, ArrowRight, User, LogOut } from "lucide-react";
...
// Solutions services data for dropdown
const solutionsServices = [
  {
    id: "strategy",
    name: "Digital Strategy",
    description: "Roadmaps for digital transformation",
    icon: Target,
  ...
  },
  {
    id: "consulting",
    name: "AI Consulting",
    description: "Expert guidance on AI adoption",
    icon: Lightbulb,
...
const navLinks = [
  ...
  { label: "Assessment", href: "/solutions/assessment", hasDropdown: false },
  { label: "Workshops", href: "/solutions/workshops", hasDropdown: false },
...
function Logo({ className }: { className?: string }) {
  return (
    <Link href="/solutions" className={cn("flex items-center gap-2", className)}>
      <div className="relative flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-amber-500 to-amber-600">
        <span className="text-white font-display font-bold text-sm">PB</span>
        <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-amber-500 to-amber-600 blur-md opacity-50" />
      </div>
      <span className="font-display font-bold text-xl tracking-tight">
        <span className="text-gradient-amber">Pink</span>
        <span className="text-foreground"> Beam</span>
      </span>
      <span className="hidden sm:inline-flex text-xs font-medium text-muted-foreground ml-1 px-2 py-0.5 rounded-full border border-amber-500/30 bg-amber-500/10 text-amber-500">
        Solutions
      </span>
    </Link>
  );
...
function ServiceCard({ service }: { service: typeof solutionsServices[0] }) {
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56" align="end" forceMount>
        ...
        <DropdownMenuItem asChild>
          <Link href="/solutions/dashboard" className="cursor-pointer">
              ...
              >
                ...
                >
                  ...
                  <div className="mt-3 pt-3 border-t border-border">
                    ...
                    >
                      <button className="flex items-center justify-between w-full px-3 py-2 text-sm font-medium text-amber-500 hover:bg-amber-500/10 rounded-lg transition-colors">
      ...
      <SheetContent side="right" className="w-full sm:w-[400px] p-0">
        <SheetHeader className="p-6 border-b border-border">
          <SheetTitle className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-amber-500 ml-1 px-2 py-0.5 rounded-full border border-amber-500/30 bg-amber-500/10">
              Solutions
            </span>
          </SheetTitle>
        </SheetHeader>
        ...
        <div className="flex flex-col h-[calc(100vh-140px)] overflow-y-auto">
          ...
          <div className="border-b border-border">
            ...
            >
              <span className="font-display font-semibold text-foreground">Solutions Services</span>
              <span
          ...
          {!user && (
            <div className="mt-auto p-4 space-y-3">
              ...
              <SheetClose asChild>
                <Link href="/sign-up">
                  <Button className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:opacity-90" size="lg">
                    Book Consultation
                  </Button>
                </Link>
              </SheetClose>
              <p className="text-xs text-center text-muted-foreground">
                Free 60-min strategy session.
              </p>
            </div>
          )}
        </div>
                ...
                <>
                  {user ? (
                    ...
                    <>
                      ...
                      <Link href="/sign-up">
                        <Button className="bg-gradient-to-r from-amber-500 to-amber-600 hover:opacity-90" size="sm">
                          Book Consultation
                        </Button>
                      </Link>
                    </>
