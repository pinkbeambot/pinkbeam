...
// Web-specific nav links
const navLinks = [
  { label: "Services", href: "/web#services", hasDropdown: false },
  { label: "Pricing", href: "/web#pricing", hasDropdown: false },
  { label: "Portfolio", href: "/web#portfolio", hasDropdown: false },
            ...
            {user ? (
              ...
              <div className="hidden sm:flex items-center gap-2">
                ...
                <Button size="sm" className="bg-gradient-beam hover:opacity-90" asChild>
                  <Link href="/web#contact">Get Started</Link>
                </Button>
              </div>
            )}
